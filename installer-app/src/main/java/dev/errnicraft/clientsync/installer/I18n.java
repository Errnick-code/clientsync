...
public class I18n {
    ...
    static {
        ...
        put("ru", "auto_update", "Обновлять при запуске игры");
        put("en", "auto_update", "Update on game launch");
        put("de", "auto_update", "Beim Spielstart aktualisieren");
        put("fr", "auto_update", "Mettre à jour au lancement du jeu");
        put("es", "auto_update", "Actualizar al iniciar el juego");
        put("pt", "auto_update", "Atualizar ao iniciar o jogo");
        put("uk", "auto_update", "Оновлювати при запуску гри");
        put("be", "auto_update", "Абнаўляць пры запуску гульні");
        put("kk", "auto_update", "Ойынды іске қосқанда жаңарту");
        put("pl", "auto_update", "Aktualizuj przy uruchamianiu gry");
        put("tr", "auto_update", "Oyun açılırken güncelle");
        put("zh", "auto_update", "游戏启动时更新");
        put("it", "auto_update", "Aggiorna all'avvio del gioco");
        put("ja", "auto_update", "ゲーム起動時に更新");
        put("ko", "auto_update", "게임 시작 시 업데이트");
        put("nl", "auto_update", "Bijwerken bij het starten van het spel");
        put("cs", "auto_update", "Aktualizovat při spuštění hry");
        put("sv", "auto_update", "Uppdatera vid spelstart");
        put("vi", "auto_update", "Cập nhật khi khởi động trò chơi");
        put("id", "auto_update", "Perbarui saat game diluncurkan");
        put("ar", "auto_update", "التحديث عند تشغيل اللعبة");

        put("ru", "auto_update_checking", "Проверка обновлений...");
        put("en", "auto_update_checking", "Checking for updates...");
        put("de", "auto_update_checking", "Suche nach Updates...");
        put("fr", "auto_update_checking", "Recherche de mises à jour...");
        put("es", "auto_update_checking", "Buscando actualizaciones...");
        put("pt", "auto_update_checking", "Verificando atualizações...");
        put("uk", "auto_update_checking", "Перевірка оновлень...");
        put("be", "auto_update_checking", "Праверка абнаўленняў...");
        put("kk", "auto_update_checking", "Жаңартулар тексерілуде...");
        put("pl", "auto_update_checking", "Sprawdzanie aktualizacji...");
        put("tr", "auto_update_checking", "Güncellemeler kontrol ediliyor...");
        put("zh", "auto_update_checking", "正在检查更新...");
        put("it", "auto_update_checking", "Ricerca aggiornamenti...");
        put("ja", "auto_update_checking", "更新を確認しています...");
        put("ko", "auto_update_checking", "업데이트 확인 중...");
        put("nl", "auto_update_checking", "Bijwerken controleren...");
        put("cs", "auto_update_checking", "Kontrola aktualizací...");
        put("sv", "auto_update_checking", "Söker uppdateringar...");
        put("vi", "auto_update_checking", "Đang kiểm tra cập nhật...");
        put("id", "auto_update_checking", "Memeriksa pembaruan...");
        put("ar", "auto_update_checking", "جارٍ التحقق من التحديثات...");

        put("ru", "im_auto_up_to_date_title", "Обновлений нет");
        put("en", "im_auto_up_to_date_title", "Up to date");
        put("de", "im_auto_up_to_date_title", "Alles aktuell");
        put("fr", "im_auto_up_to_date_title", "À jour");
        put("es", "im_auto_up_to_date_title", "Sin novedades");
        put("pt", "im_auto_up_to_date_title", "Tudo atualizado");
        put("uk", "im_auto_up_to_date_title", "Оновлень немає");
        put("be", "im_auto_up_to_date_title", "Абнаўленняў няма");
        put("kk", "im_auto_up_to_date_title", "Жаңартулар жоқ");
        put("pl", "im_auto_up_to_date_title", "Brak aktualizacji");
        put("tr", "im_auto_up_to_date_title", "Güncelleme yok");
        put("zh", "im_auto_up_to_date_title", "已是最新");
        put("it", "im_auto_up_to_date_title", "Già aggiornato");
        put("ja", "im_auto_up_to_date_title", "最新です");
        put("ko", "im_auto_up_to_date_title", "최신 상태입니다");
        put("nl", "im_auto_up_to_date_title", "Alles up-to-date");
        put("cs", "im_auto_up_to_date_title", "Vše je aktuální");
        put("sv", "im_auto_up_to_date_title", "Redan uppdaterat");
        put("vi", "im_auto_up_to_date_title", "Đã cập nhật");
        put("id", "im_auto_up_to_date_title", "Sudah terbaru");
        put("ar", "im_auto_up_to_date_title", "لا توجد تحديثات");

        put("ru", "im_auto_up_to_date_message", "Обновления не требуются.");
        put("en", "im_auto_up_to_date_message", "No updates required.");
        put("de", "im_auto_up_to_date_message", "Keine Aktualisierung erforderlich.");
        put("fr", "im_auto_up_to_date_message", "Aucune mise à jour nécessaire.");
        put("es", "im_auto_up_to_date_message", "No se requieren actualizaciones.");
        put("pt", "im_auto_up_to_date_message", "Nenhuma atualização necessária.");
        put("uk", "im_auto_up_to_date_message", "Оновлення не потрібні.");
        put("be", "im_auto_up_to_date_message", "Абнаўленні не патрабуюцца.");
        put("kk", "im_auto_up_to_date_message", "Жаңартулар қажет емес.");
        put("pl", "im_auto_up_to_date_message", "Aktualizacje nie są wymagane.");
        put("tr", "im_auto_up_to_date_message", "Güncelleme gerekmiyor.");
        put("zh", "im_auto_up_to_date_message", "无需更新。");
        put("it", "im_auto_up_to_date_message", "Nessun aggiornamento richiesto.");
        put("ja", "im_auto_up_to_date_message", "更新は必要ありません。");
        put("ko", "im_auto_up_to_date_message", "업데이트가 필요하지 않습니다.");
        put("nl", "im_auto_up_to_date_message", "Geen updates vereist.");
        put("cs", "im_auto_up_to_date_message", "Aktualizace nejsou nutné.");
        put("sv", "im_auto_up_to_date_message", "Inga uppdateringar krävs.");
        put("vi", "im_auto_up_to_date_message", "Không cần cập nhật.");
        put("id", "im_auto_up_to_date_message", "Tidak ada pembaruan yang diperlukan.");
        put("ar", "im_auto_up_to_date_message", "لا حاجة للتحديث.");

        put("ru", "im_auto_update_failed_title", "Автообновление не удалось");
        put("en", "im_auto_update_failed_title", "Auto-update failed");
        put("de", "im_auto_update_failed_title", "Automatische Aktualisierung fehlgeschlagen");
        put("fr", "im_auto_update_failed_title", "Échec de la mise à jour automatique");
        put("es", "im_auto_update_failed_title", "Error en la actualización automática");
        put("pt", "im_auto_update_failed_title", "Falha na atualização automática");
        put("uk", "im_auto_update_failed_title", "Автооновлення не вдалося");
        put("be", "im_auto_update_failed_title", "Аўтаабнаўленне не атрымалася");
        put("kk", "im_auto_update_failed_title", "Авто-жаңарту орындалмады");
        put("pl", "im_auto_update_failed_title", "Automatyczna aktualizacja nie powiodła się");
        put("tr", "im_auto_update_failed_title", "Otomatik güncelleme başarısız");
        put("zh", "im_auto_update_failed_title", "自动更新失败");
        put("it", "im_auto_update_failed_title", "Aggiornamento automatico fallito");
        put("ja", "im_auto_update_failed_title", "自動更新に失敗しました");
        put("ko", "im_auto_update_failed_title", "자동 업데이트 실패");
        put("nl", "im_auto_update_failed_title", "Automatische update mislukt");
        put("cs", "im_auto_update_failed_title", "Automatická aktualizace selhala");
        put("sv", "im_auto_update_failed_title", "Automatisk uppdatering misslyckades");
        put("vi", "im_auto_update_failed_title", "Cập nhật tự động thất bại");
        put("id", "im_auto_update_failed_title", "Pembaruan otomatis gagal");
        put("ar", "im_auto_update_failed_title", "فشل التحديث التلقائي");
        ...
        put("ru", "theme", "Тема");
        put("ru", "theme_system", "Системная");
        put("ru", "theme_light", "Светлая");
        put("ru", "theme_dark", "Тёмная");
        put("en", "theme", "Theme");
        put("en", "theme_system", "System");
        put("en", "theme_light", "Light");
        put("en", "theme_dark", "Dark");
        put("de", "theme", "Design");
        put("de", "theme_system", "System");
        put("de", "theme_light", "Hell");
        put("de", "theme_dark", "Dunkel");
        put("fr", "theme", "Thème");
        put("fr", "theme_system", "Système");
        put("fr", "theme_light", "Clair");
        put("fr", "theme_dark", "Sombre");
        put("es", "theme", "Tema");
        put("es", "theme_system", "Sistema");
        put("es", "theme_light", "Claro");
        put("es", "theme_dark", "Oscuro");
        put("pt", "theme", "Tema");
        put("pt", "theme_system", "Sistema");
        put("pt", "theme_light", "Claro");
        put("pt", "theme_dark", "Escuro");
        put("uk", "theme", "Тема");
        put("uk", "theme_system", "Системна");
        put("uk", "theme_light", "Світла");
        put("uk", "theme_dark", "Темна");
        put("be", "theme", "Тэма");
        put("be", "theme_system", "Сістэмная");
        put("be", "theme_light", "Светлая");
        put("be", "theme_dark", "Цёмная");
        put("kk", "theme", "Тақырып");
        put("kk", "theme_system", "Жүйелік");
        put("kk", "theme_light", "Ашық");
        put("kk", "theme_dark", "Қараңғы");
        put("pl", "theme", "Motyw");
        put("pl", "theme_system", "Systemowy");
        put("pl", "theme_light", "Jasny");
        put("pl", "theme_dark", "Ciemny");
        put("tr", "theme", "Tema");
        put("tr", "theme_system", "Sistem");
        put("tr", "theme_light", "Açık");
        put("tr", "theme_dark", "Koyu");
        put("zh", "theme", "主题");
        put("zh", "theme_system", "系统");
        put("zh", "theme_light", "浅色");
        put("zh", "theme_dark", "深色");
        put("it", "theme", "Tema");
        put("it", "theme_system", "Sistema");
        put("it", "theme_light", "Chiaro");
        put("it", "theme_dark", "Scuro");
        put("ja", "theme", "テーマ");
        put("ja", "theme_system", "システム");
        put("ja", "theme_light", "ライト");
        put("ja", "theme_dark", "ダーク");
        put("ko", "theme", "테마");
        put("ko", "theme_system", "시스템");
        put("ko", "theme_light", "밝게");
        put("ko", "theme_dark", "어둡게");
        put("nl", "theme", "Thema");
        put("nl", "theme_system", "Systeem");
        put("nl", "theme_light", "Licht");
        put("nl", "theme_dark", "Donker");
        put("cs", "theme", "Motiv");
        put("cs", "theme_system", "Systémový");
        put("cs", "theme_light", "Světlý");
        put("cs", "theme_dark", "Tmavý");
        put("sv", "theme", "Tema");
        put("sv", "theme_system", "System");
        put("sv", "theme_light", "Ljus");
        put("sv", "theme_dark", "Mörk");
        put("vi", "theme", "Chủ đề");
        put("vi", "theme_system", "Hệ thống");
        put("vi", "theme_light", "Sáng");
        put("vi", "theme_dark", "Tối");
        put("id", "theme", "Tema");
        put("id", "theme_system", "Sistem");
        put("id", "theme_light", "Terang");
        put("id", "theme_dark", "Gelap");
        put("ar", "theme", "المظهر");
        put("ar", "theme_system", "النظام");
        put("ar", "theme_light", "فاتح");
        put("ar", "theme_dark", "داكن");
    }
